...
const INIT_TABLES = [
  ...
  "CREATE TABLE IF NOT EXISTS sylvias_stock_checks (id INTEGER PRIMARY KEY AUTOINCREMENT, check_type TEXT NOT NULL DEFAULT 'spot', location TEXT NOT NULL DEFAULT '', total_items INTEGER NOT NULL DEFAULT 0, items_found INTEGER NOT NULL DEFAULT 0, items_missing INTEGER NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'in_progress', checked_by TEXT NOT NULL DEFAULT '', started_at TEXT NOT NULL DEFAULT (datetime('now')), completed_at TEXT DEFAULT NULL, notes TEXT NOT NULL DEFAULT '')",
  "CREATE TABLE IF NOT EXISTS sylvias_stock_check_items (id INTEGER PRIMARY KEY AUTOINCREMENT, check_id INTEGER NOT NULL, stock_id INTEGER NOT NULL, description TEXT NOT NULL DEFAULT '', part_number TEXT NOT NULL DEFAULT '', location TEXT NOT NULL DEFAULT '', expected_qty INTEGER NOT NULL DEFAULT 1, actual_qty INTEGER DEFAULT NULL, status TEXT NOT NULL DEFAULT 'pending', resolution TEXT NOT NULL DEFAULT '', resolution_notes TEXT NOT NULL DEFAULT '', signed_off_by TEXT NOT NULL DEFAULT '', signed_off_at TEXT DEFAULT NULL, FOREIGN KEY (check_id) REFERENCES sylvias_stock_checks(id))",
];
